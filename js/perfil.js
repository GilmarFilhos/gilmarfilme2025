...
function incicializarDados () {
   ...
   },
   {
    ...
    crianca: true
        ...
        localStorage.setItem("galloflix-uses",JSON.stringify(dados));
    }
 perfil = dados;
}
// ao carregar a pagina exculta as funçoes de buscar dados
...
cards.innerHTML += `<div class="card rouded-4">
    <a data-bs-toggle="modal" data-bs-target="#addPerfil"

    class="text-decoration-none d-flex flex-fill">

<i class='bx bxs-plus-circle rounded-4 d-flex justify-content-center align-items-center flex-fill'>
...
function adicionarPerfil() {
   ...
   perfis.push(perfil);
   localStorage.setItem("gilmarfimes2025-users" , JSON.stringify(perfis));
